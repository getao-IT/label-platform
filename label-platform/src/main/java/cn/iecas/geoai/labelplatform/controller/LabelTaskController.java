...
//    }
    ...
    public CommonResult<List<VideoFrame>> getFrameImgByFrameNbr(String videoPath, int frameNumber, int returnNumber) { List<VideoFrame> result = this.labelTaskService.getFrameImgByFrameNbr(videoPath, frameNumber, returnNumber);
