package cn.iecas.geoai.labelplatform.aop.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(cn.iecas.geoai.labelplatform.aop.annotation.Log)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        String methodName = ((MethodSignature)point.getSignature()).getMethod().getAnnotation(cn.iecas.geoai.labelplatform.aop.annotation.Log.class).value();
